...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/language5pto

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/language5pto: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/language5pto ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/b3bda9e/Language.o: ../../UGRMPBase/NetBeansProjects/Language5/src/Language.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b3bda9e
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b3bda9e/Language.o ../../UGRMPBase/NetBeansProjects/Language5/src/Language.cpp
