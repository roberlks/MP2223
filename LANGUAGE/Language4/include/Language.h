 ...
 * Author: roberlks222
 *
 * Created on 17 de marzo de 2023, 18:25
 */
...
public:
    ...
    /**
     * @brief Updates the size of this object to @p nsize
     * @param nsize The new size the object must have. Should be greater than this->_size
     * @throw std::out_of_range if the new size is smaller than the previous size
     */
