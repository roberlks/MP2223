...
public:
    ...
    /**
     * @brief Returns de valid characters string from this object
     * @return _validCharacters string
     */
    std::string getValidChar() const;
    /**
...
private:
    ...
    /**
     * @brief Gives the position of a char in the string.
     * @param c The char to look for
     * @return position of @p c in the string. -1 if it is invalid
     */
    int CharToPos(char c)const;
    
    /**
     * @brief Gives the char assigned to an @p n position
     * @param n Position to know the char assigned to
     * @return Char assigned to @p n
     */
    char PosToChar(int n)const ;
