...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/PruebasCustom/TestingMain.o \
...
${OBJECTDIR}/PruebasCustom/TestingMain.o: PruebasCustom/TestingMain.cpp
	${MKDIR} -p ${OBJECTDIR}/PruebasCustom
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PruebasCustom/TestingMain.o PruebasCustom/TestingMain.cpp

${OBJECTDIR}/src/Bigram.o: src/Bigram.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Bigram.o src/Bigram.cpp
